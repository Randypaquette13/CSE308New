...
district1Counter,district2Counter,district3Counter,district4Counter,district5Counter,district6Counter,district7Counter,district8Counter = 0,0,0,0,0,0,0,0
with open('output1.json','r') as f:
	jsonData = json.load(f)
	features = jsonData['features']
	for line in features:
		line['properties']['OID_'] = counter
		if(line['geometry']['type'] == 'MultiPolygon'):
			coordinates = line['geometry']['coordinates'][0][0][0]
			tupleCoordinate = tuple(coordinates)
