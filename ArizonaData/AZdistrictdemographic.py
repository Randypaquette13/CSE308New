...
d9Total,d9HispanicLatino,d9White,d9Black,d9AIAN,d9Asian,d9NHOPI = 0,0,0,0,0,0,0
totalRepub = 0
totalDemo = 0
...
with open('output2.json','r') as f:
	...
	for line in features:
		...
		elif(line['properties']['District'] == 9):
			d9Total += line['properties']['Total']
			d9HispanicLatino += line['properties']['Hispanic/Latino']
			d9White += line['properties']['White']
			d9Black += line['properties']['Black']
			d9AIAN += line['properties']['AI/AN']
			d9Asian += line['properties']['Asian']
			d9NHOPI += line['properties']['NH/OPI']

		else:
			print("wtf")

	with open('AZ-FULL.json','r+') as f2:
		...
		districtFeature[8]['properties']['Total'] = d9Total
		districtFeature[8]['properties']['Hispanic/Latino'] = d9HispanicLatino
		districtFeature[8]['properties']['White'] = d9White
		districtFeature[8]['properties']['Black'] = d9Black
		districtFeature[8]['properties']['AI/AN'] = d9AIAN
		districtFeature[8]['properties']['Asian'] = d9Asian
		districtFeature[8]['properties']['NH/OPI'] = d9NHOPI
